...
class RenameNilFix {
    ...
    static final dirs = [
        ...
        "export/release/ios/obj/obj/",
        "export/release/ios/obj/obj/iphoneos/",
        "export/release/ios/obj/obj/iphoneos-arm64/",
        "export/release/ios/obj/include/thx/",
        "export/release/ios/obj/src/thx/",
        "export/release/mac/obj/include/thx/",
        "export/release/mac/obj/src/thx/",
    ...
    public static function main() {
        for (dir in dirs) {
            ...
            for (file in FileSystem.readDirectory(dir)) {
                if (!StringTools.endsWith(file, ".h") && !StringTools.endsWith(file, ".cpp")) continue;
